...
@section('content')
    ...
    <div class="row g-3 justify-content-center">
        <div class="col-sm-10">
            <h4 class="bg-primary text-white p-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-up" viewBox="0 0 16 16">
            ...
            <table class="table table-condensed mt-2">
                ...
                @foreach($user->route as $route)
                    <tr>
                        ...
                        @can('update', $route)
                            <td>
                                <a href="{{route('route.edit', ['id' => $route->id])}}" class="btn btn-sm btn-outline-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
                        ...
                        @can('delete', $route)
                            <td>
                                <a href="{{route('route.delete', ['id' => $route->id])}}" class="btn btn-sm btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
